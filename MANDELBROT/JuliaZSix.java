...
public class JuliaZSix implements Fractal {
	...
	public JuliaZSix(double c_real, double c_imaginary) throws IOException {
		c.setReal(c_real);
	...
	public void createImage() {
		...
		try {
			ImageIO.write(image, "png", new File("juliaZSix.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) throws IOException {
		Fractal juliatest = new JuliaZSix(0.590, 0);
	...
	public void nextIteration(Complex z, Complex constant) {
		...
		z.setReal(r * r * r * r * r * r
				- 15 * r * r * r * r * i * i
				+ 15 * r * r* i * i * i * i
				- i * i * i * i * i * i
				+ constant.getReal());
		z.setImaginary(6 * r * r * r * r * r * i 
				- 20 * r * r * r * i * i * i
				+ 6 * r * i * i * i * i * i 
