...
public class JuliaZFour implements Fractal {
	...
	public JuliaZFour(double c_real, double c_imaginary) throws IOException {
		c.setReal(c_real);
	...
	public void createImage() {
		...
		try {
			ImageIO.write(image, "png", new File("juliaZFour.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) throws IOException {
		Fractal juliatest = new JuliaZFour(0.484, 0);
	...
	public void nextIteration(Complex z, Complex constant) {
		...
		z.setReal(oldreal * oldreal * oldreal * oldreal - 6 * oldreal * oldreal
				* oldimaginary * oldimaginary + oldimaginary * oldimaginary
				* oldimaginary * oldimaginary + constant.getReal());
		z.setImaginary(4 * oldreal * oldreal * oldreal * oldimaginary - 4
				* oldreal * oldimaginary * oldimaginary * oldimaginary + constant.getImaginary());
	}
}
