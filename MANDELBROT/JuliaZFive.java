...
public class JuliaZFive implements Fractal {
	...
	public JuliaZFive(double c_real, double c_imaginary) throws IOException {
		c.setReal(c_real);
	...
	public void createImage() {
		...
		try {
			ImageIO.write(image, "png", new File("juliaZFive.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) throws IOException {
		Fractal juliatest = new JuliaZFive(0.544, 0);
