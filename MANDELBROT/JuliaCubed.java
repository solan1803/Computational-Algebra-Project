...
public class JuliaCubed implements Fractal {
	...
	static int[] colours1 = { 0x000000, 0x0000019, 0x000033, 0x00004c,
	...
	public JuliaCubed(double c_real, double c_imaginary) throws IOException {
		c.setReal(c_real);
	...
	public void createImage() {
		...
		try {
			ImageIO.write(image, "png", new File("juliaCubed0.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) throws IOException {
		Fractal juliatest = new JuliaCubed(0, 0);
	...
	public void nextIteration(Complex z, Complex constant) {
		...
		z.setReal(oldreal * oldreal * oldreal - 3 * oldreal * oldimaginary
				* oldimaginary + constant.getReal());
		z.setImaginary(3 * oldreal * oldreal * oldimaginary - oldimaginary
